<x-dashboard-layout>
  ...
  <p>
    Halaman Create post untuk menambahkan postingan baru.
  </p>
  <div class="alert alert-warning " role="alert">
          Dilarang membuat postingan yang mengandung unsur Sara, Rasis, Seksual, atau
          Jomok!!!
          </div>
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold
        text-primary">Post Create Form</h6>
    </div>
    <div class="card-body">
      <form action="{{ route('dashboard.posts.create') }}" method="post"
        ...
        <div class="mb-3">
          ...
          placeholder="Masukan judul post" value="{{ old('title') }}" autofocus>
          @error('title')
        ...
        <div class="mb-3">
          ...
          form-control" id="formFile" name="image" value="{{ old('image') }}">
          @error('image')
          <div class="invalid-feedback ">
            {{ $message }}
          </div>
